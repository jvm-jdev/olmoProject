          ...
          <div className="row row-cols-1 row-cols-md-2">
            ...
            <div className="col">
              <div className="fbox-4 pr-25 mb-40 wow fadeInUp">
                ...
                <div className="fbox-txt">
                  {/* Title */}
                  <h5 className="h5-md">Prepaid Visa Card</h5>
                  {/* Text */}
                  <p className="p-lg">
            ...
            <div className="col">
              <div className="fbox-4 pl-25 mb-40 wow fadeInUp">
                ...
                <div className="fbox-txt">
                  {/* Title */}
                  <h5 className="h5-md">Virtual Wallet</h5>
                  {/* Text */}
                  <p className="p-lg">
                    Porta semper lacus cursus feugiat primis ultrice ligula
                    risus auctor tempus feugiat impedit undo auctor felis augue
            ...
            <div className="col">
              <div className="fbox-4 pr-25 mb-40 wow fadeInUp">
                ...
                <div className="fbox-txt">
                  {/* Title */}
                  <h5 className="h5-md">Mobile Banking</h5>
                  {/* Text */}
                  <p className="p-lg">
                    Porta semper lacus cursus feugiat primis ultrice ligula
                    risus auctor tempus feugiat impedit undo auctor felis augue
            ...
            <div className="col">
              <div className="fbox-4 pl-25 mb-40 wow fadeInUp">
                ...
                <div className="fbox-ico">
                  <div className="ico-65">
                    <span className="flaticon-negotiation" />
                  </div>
                </div>
                {/* Text */}
                <div className="fbox-txt">
                  {/* Title */}
                  <h5 className="h5-md">Send &amp; Receive Money</h5>
                  {/* Text */}
                  <p className="p-lg">
                    Porta semper lacus cursus feugiat primis ultrice ligula
                    risus auctor tempus feugiat impedit undo auctor felis augue
            ...
            <div className="col">
              <div className="fbox-4 pr-25 mb-40 wow fadeInUp">
                ...
                <div className="fbox-txt">
                  {/* Title */}
                  <h5 className="h5-md">Payments Activity</h5>
                  {/* Text */}
                  <p className="p-lg">
                    Porta semper lacus cursus feugiat primis ultrice ligula
                    risus auctor tempus feugiat impedit undo auctor felis augue
            ...
            <div className="col">
              <div className="fbox-4 pl-25 mb-40 wow fadeInUp">
                ...
                <div className="fbox-ico">
                  <div className="ico-65">
                    <span className="flaticon-rotation-lock" />
                  </div>
                </div>
                {/* Text */}
                <div className="fbox-txt">
                  {/* Title */}
                  <h5 className="h5-md">Card Lock &amp; Unlock</h5>
                  {/* Text */}
                  <p className="p-lg">
                    Porta semper lacus cursus feugiat primis ultrice ligula
                    risus auctor tempus feugiat impedit undo auctor felis augue
...
export default Demo14features4;
